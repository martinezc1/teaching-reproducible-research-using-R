...
1.  **One insight about `time_of_day`**\
    Example format: “Shootings are more frequent during \_\_\_ than \_\_\_ suggestion...”
...
Copy this template into your script and complete the tasks above. (@R-tidyverse) (@R-lubridate) (@R-nycOpenData)
